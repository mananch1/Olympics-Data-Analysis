...
athelete_df = pd.read_csv("athlete_events.csv")
...
if user_menu == 'Overall Analysis':
    ...
    st.title('No of Athelets participating over the years')
...
if user_menu == 'Country-wise Analysis':
    ...
    st.plotly_chart(fig,key='CountryMedal')
